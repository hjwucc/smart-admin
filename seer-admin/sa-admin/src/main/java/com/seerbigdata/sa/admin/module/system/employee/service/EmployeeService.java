package com.seerbigdata.sa.admin.module.system.employee.service;

import cn.dev33.satoken.stp.StpUtil;
import cn.hutool.core.util.StrUtil;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.google.common.collect.Lists;
import com.seerbigdata.sa.admin.module.system.employee.domain.form.*;
import jakarta.annotation.Resource;
import com.seerbigdata.sa.admin.module.system.department.dao.DepartmentDao;
...
import com.seerbigdata.sa.admin.module.system.employee.dao.EmployeeDao;
import com.seerbigdata.sa.admin.module.system.employee.domain.entity.EmployeeEntity;
import com.seerbigdata.sa.admin.module.system.employee.domain.vo.EmployeeVO;
import com.seerbigdata.sa.admin.module.system.employee.manager.EmployeeManager;
import com.seerbigdata.sa.admin.module.system.login.service.LoginService;
import com.seerbigdata.sa.admin.module.system.position.dao.PositionDao;
import com.seerbigdata.sa.admin.module.system.position.domain.entity.PositionEntity;
import com.seerbigdata.sa.admin.module.system.role.dao.RoleEmployeeDao;
import com.seerbigdata.sa.admin.module.system.role.domain.vo.RoleEmployeeVO;
...
public class EmployeeService {
    ...
    public synchronized ResponseDTO<String> addEmployee(EmployeeAddForm employeeAddForm) {
        ...
        // 默认新增用户不禁用
        if (null == employeeAddForm.getDisabledFlag()) {
        ...
        // 设置密码 随机密码
        String password = StrUtil.isEmpty(employeeAddForm.getLoginPwd()) ? securityPasswordService.randomPassword() : employeeAddForm.getLoginPwd();
        String generateSaltPassword = this.generateSaltPassword(password, employeeUid);
    ...
    public ResponseDTO<String> passwordReset(@Valid EmployeeResetPwdForm form) {
        EmployeeEntity employeeEntity = employeeDao.selectById(form.getEmployeeId());
        if (employeeEntity == null) {
            return ResponseDTO.error(UserErrorCode.DATA_NOT_EXIST);
        }

        String password = form.getResetPwd();
        String saltPassword = this.generateSaltPassword(password, employeeEntity.getEmployeeUid());
        employeeDao.updatePassword(form.getEmployeeId(), SecurityPasswordService.getEncryptPwd(saltPassword));
        return ResponseDTO.ok();
    }
