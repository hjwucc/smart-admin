package com.seerbigdata.sa.admin.module.system.employee.controller;
...
import com.seerbigdata.sa.base.module.support.apiencrypt.annotation.ApiDecrypt;
...
public class EmployeeController {
    ...
    @Operation(summary = "重置员工密码 ")
    @PostMapping("/employee/update/passwordReset")
    public ResponseDTO<String> passwordReset(@Valid @RequestBody EmployeeResetPwdForm form) {
        return employeeService.passwordReset(form);
    }
