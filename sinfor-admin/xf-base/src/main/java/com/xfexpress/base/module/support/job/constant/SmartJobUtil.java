package com.xfexpress.base.module.support.job.constant;
...
public class SmartJobUtil {
    ...
    public static void main(String[] args) {
        ...
        ResponseDTO<String> res = checkJobClass("com.xfexpress.base.module.support.job.sample.SmartJobSample1");
