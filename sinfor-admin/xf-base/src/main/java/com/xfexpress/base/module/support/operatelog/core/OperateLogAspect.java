package com.xfexpress.base.module.support.operatelog.core;
...
import com.xfexpress.base.module.support.operatelog.OperateLogDao;
import com.xfexpress.base.module.support.operatelog.annotation.OperateLog;
...
public abstract class OperateLogAspect {
    ...
    private static final String POINT_CUT = "@within(com.xfexpress.base.module.support.operatelog.annotation.OperateLog) || @annotation(com.xfexpress.base.module.support.operatelog.annotation.OperateLog)";
