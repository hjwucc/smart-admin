package com.xfexpress.base.module.support.codegenerator.service.variable.backend;

import com.google.common.base.CaseFormat;
import com.xfexpress.base.common.util.SmartEnumUtil;
import com.xfexpress.base.module.support.codegenerator.constant.CodeDeleteEnum;
    ...
    public List<String> getPackageList(List<CodeInsertAndUpdateField> fields, CodeGeneratorConfigForm form) {
        ...
        if (form.getDeleteInfo().getIsSupportDelete()) {
            ...
            if (codeDeleteEnum == CodeDeleteEnum.BATCH || codeDeleteEnum == CodeDeleteEnum.SINGLE_AND_BATCH) {
                ...
                packageSet.add("import com.xfexpress.base.common.domain.ValidateList;");
            }
